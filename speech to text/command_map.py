command_map = {
    ...
    "open fingers": [
        "open fingers", "open the fingers", "open my fingers", "please open my fingers",
        "can you open my fingers", "i want to open my fingers", "extend my fingers",
        "straighten my fingers", "uncurl my fingers", "spread my fingers",
        "open the prosthetic fingers", "open the robotic fingers", "open the artificial fingers"
    ],
    "close fingers": [
        "close fingers", "close the fingers", "close my fingers", "please close my fingers",
        "can you close my fingers", "i want to close my fingers", "curl my fingers",
        "fold my fingers", "clench my fingers", "tighten my fingers",
        "close the prosthetic fingers", "close the robotic fingers", "close the artificial fingers"
    ],
    "open thumb": [
